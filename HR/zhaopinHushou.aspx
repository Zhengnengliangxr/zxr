<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zhaopinHushou.aspx.cs" Inherits="zhaopinHushou" %>
    ...
    <div>
          ...
          <asp:GridView ID="GridView1" runat="server" AllowPaging="True"  ShowHeaderWhenEmpty="True"
                        ...
                        <Columns>        
                                        ...
                                        <asp:BoundField DataField="JL_fujian" HeaderText="简历" 
                                            SortExpression="JL_fujian" />
        ...
        <asp:Button ID="Button1" runat="server" Text="清空回收站" OnClick="Button1_Click"  />
    </div>
    </form>
</body>
</html>
